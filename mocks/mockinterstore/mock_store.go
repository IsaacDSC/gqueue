...
// Source: internal/interstore/store.go
//
// Generated by this command:
//
//	mockgen -source=internal/interstore/store.go -destination=./mocks/mockinterstore/mock_store.go -package=mockinterstore
//
...
func (mr *MockRepositoryMockRecorder) GetAllEvents(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllEvents", reflect.TypeOf((*MockRepository)(nil).GetAllEvents), ctx)
}

// GetAllSchedulers mocks base method.
func (m *MockRepository) GetAllSchedulers(ctx context.Context, state string) ([]domain.Event, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) GetAllSchedulers(ctx, state any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllSchedulers", reflect.TypeOf((*MockRepository)(nil).GetAllSchedulers), ctx, state)
}
