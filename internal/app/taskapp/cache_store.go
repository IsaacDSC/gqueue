...
func (c Cache) FindAllQueues(ctx context.Context) ([]Queue, error) {
...
func (c Cache) GetMsgArchivedTask(ctx context.Context, queue, taskName string) (RawMsg, error) {
