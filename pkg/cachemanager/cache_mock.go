...
// Source: pkg/cachemanager/adapter.go
//
...
func (m *MockCache) IncrementValue(ctx context.Context, key Key, value any) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IncrementValue", ctx, key, value)
	ret0, _ := ret[0].(error)
	return ret0
}

// IncrementValue indicates an expected call of IncrementValue.
func (mr *MockCacheMockRecorder) IncrementValue(ctx, key, value any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IncrementValue", reflect.TypeOf((*MockCache)(nil).IncrementValue), ctx, key, value)
}
