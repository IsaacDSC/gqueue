...
IMPLEMENTANDO TaskConsumerLagSeconds


## Metricas
- Reusar metricas
- Criar metricas para saber o lag por tópico
- Ajustar dashboard de métricas
    - RPM/RPS publisher
    - P95 http-server - publisher (Tempo de consumo)
    - RPM/RPS consumer
    - P95 http-client - consumer (Tempo de consumo)